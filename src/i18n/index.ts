...
export const I18N: Record<Lang, I18nStrings> = {
  es: {
    ...
    hero: {
      ...
      sub: '13 cursos en vivo, secuenciales y prácticos. Aprende Excel, SQL, Python, Power BI y Claude en el orden correcto y construye un portafolio real.',
    ...
    route: {
      ...
      sub: 'Cada curso desbloquea al siguiente. Empiezas por los fundamentos y terminas dominando las cinco herramientas del analista moderno.',
      legend: 'Herramientas', step: 'Curso',
      image_label: 'Vista general de la ruta',
      image_caption: 'La Ruta del Analista de Datos · 13 cursos · 90 horas en vivo',
    },
    courses: {
      kicker: 'Temario completo', title: '13 cursos, módulo por módulo',
    ...
    price: {
      ...
      sub: 'Acceso a los 13 cursos en vivo, certificado y acompañamiento. Sin mensualidades ni sorpresas.',
      badge: 'Pago único', discount_badge: '50% Descuento · Solo durante Live',
      countdown_label: 'La oferta termina en', original_label: 'Antes',
      currency: 'S/.', amount: '349.90', original: '599.90',
      ...
      features: [
        '13 cursos en vivo (9 de datos + 3 de Excel + 1 de Claude)',
  ...
  en: {
    ...
    hero: {
      ...
      sub: '13 live, sequential, hands-on courses. Learn Excel, SQL, Python, Power BI and Claude in the right order and build a real portfolio.',
    ...
    route: {
      ...
      sub: 'Each course unlocks the next. Start with the fundamentals and finish mastering the five tools of the modern analyst.',
      legend: 'Tools', step: 'Course',
      image_label: 'Path overview',
      image_caption: 'The Data Analyst Path · 13 courses · 90 live hours',
    },
    courses: {
      kicker: 'Full syllabus', title: '13 courses, module by module',
    ...
    price: {
      ...
      sub: 'Access to all 13 live courses, certificate and mentoring. No monthly fees, no surprises.',
      ...
      features: [
        '13 live courses (9 data + 3 Excel + 1 Claude)',
